...
export const homeScreenStyles = StyleSheet.create({
  ...
  cleanupReportBtn: {
    ...
    height: 48,
    borderRadius: 24,
    backgroundColor: 'rgba(15,26,15,0.92)',
    borderWidth: 1,
    borderColor: '#3d8b52',
    alignItems: 'center',
    justifyContent: 'center',
  },
  cleanupReportBtnText: { fontSize: 22 },
  cleanupReportBtnActive: {
    borderColor: '#e8a050',
    backgroundColor: 'rgba(42, 32, 16, 0.95)',
  },
  cleanupPlacementBanner: {
    position: 'absolute',
    top: 8,
    left: 8,
    right: 8,
  ...
  cleanupPlacementBannerText: {
    flex: 1,
    fontSize: 12,
    color: '#c8e6cc',
    lineHeight: 16,
  },
  cleanupPlacementActions: { flexDirection: 'row', gap: 6 },
  cleanupPlacementActionBtn: {
    width: 36,
    height: 36,
    borderRadius: 18,
    alignItems: 'center',
  ...
  cleanupPlacementConfirmBtn: {
    borderColor: '#5aad6a',
    backgroundColor: '#1e3020',
  },
  cleanupPlacementConfirmText: { fontSize: 18, color: '#5aad6a', fontWeight: '700' },
  cleanupPlacementCancelText: { fontSize: 16, color: '#c08080', fontWeight: '600' },
  creaturePopup: {
    position: 'absolute',
    bottom: 100,
    left: 20,
