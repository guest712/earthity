...
export const LANGS: Record<LanguageCode, LocaleStrings> = {
  ru: {
    ...
    authErrorMissingApiUrl: 'Не задан адрес API (EXPO_PUBLIC_API_URL)',
  ...
  de: {
    ...
    authErrorMissingApiUrl: 'API-Adresse fehlt (EXPO_PUBLIC_API_URL)',
  ...
  uk: {
    ...
    authErrorMissingApiUrl: 'Не задано адресу API (EXPO_PUBLIC_API_URL)',
  ...
  ar: {
    ...
    authErrorMissingApiUrl: 'لم يُضبط عنوان API (EXPO_PUBLIC_API_URL)',
  ...
  en: {
    ...
    authErrorMissingApiUrl: 'API URL is not set (EXPO_PUBLIC_API_URL)',
